...
\imagen{pygobstones_example}{Ejemplo de un programa Gobstones, en el IDE PyGobstones \footfullcite{PyGobstones}, con su respectivo tablero final}
...
De los entornos proyectivos existentes hoy en día, se decidió utilizar el workbench Meta Programming System (MPS) \footfullcite{MPS} de la empresa Jetbrains, en su versión 3.3.
...
Siguiendo la filosofía planteada en este trabajo, la definición del ejercicio también se visualiza como un archivo, orientado a ser legible y con apariencia de documentación, como se observa en la \fig{ejercicio1}
